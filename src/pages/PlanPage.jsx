...
import PlanSelect from "../components/Plan";
...
export default function FormPlan() {
  ...
  const planSelects = plans.map((item, index) => (
    <PlanSelect key={index} item={item} />
  ));
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      <div className="flex flex-col desktop:flex-row gap-3 desktop:gap-[1.125rem]">
        {planSelects}
      </div>
